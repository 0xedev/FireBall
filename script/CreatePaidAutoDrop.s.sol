...
contract CreatePaidAutoDrop is Script {
    // --- Configuration ---
    ...
    function run() external {
        ...
        console.log("Creating Participant-Paid (Automatic Selection) Drop on contract:", address(fireballDrop));
        ...
        console.log(unicode"✅ Participant-Paid (Automatic Selection) Drop creation transaction sent.");
