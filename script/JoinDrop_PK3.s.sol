...
contract JoinDropPk3 is Script {
    // --- Configuration ---
    ...
    uint256 constant DROP_ID_TO_JOIN = 1; // Example: Joining Drop 1
    // The name this participant will use
    string constant PARTICIPANT_NAME = "Participant Three";
    // The environment variable holding the private key for this participant
    string constant PRIVATE_KEY_ENV_VAR = "PRIVATE_KEY_3";
    // --- End Configuration ---
